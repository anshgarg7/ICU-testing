...
<div class="app-main__outer">
	<div class="app-main__inner">
		...
		<form action="functionality/updateTimeAct.php" method="post">
			<div class="wrap-input100">
				...
				<table class="table " id="dynamic_field2">
					<thead>
						<th>Days Of Visiting</th>
					</thead>
					<tr>
						<td><input type="text" name="visitingDays[]" placeholder="Enter one day at a time" class="form-control name_list" required /></td>
						<td><button type="button" name="add2" id="add2" class="mt-2 btn btn-primary">Add More</button></td>
					</tr>
				</table>
				<table class="table " id="dynamic_field">
					<thead>
						<th>OPD Opening Time</th>
					</thead>
					<tr>
						<td><input type="time" name="start_slot[]" placeholder="Enter opening time of OPD" class="form-control name_list" required /></td>
				...
				<table class="table " id="dynamic_field1">
					<thead>
						<th>OPD Closing Time</th>
					</thead>
					<tr>
						<td><input type="time" name="end_slot[]" placeholder="Enter closing time of OPD" class="form-control name_list" required /></td>
						<td><button type="button" name="add1" id="add1" class="mt-2 btn btn-primary">Add More</button></td>
					</tr>
				</table>


				<button class="mb-2 mr-2 btn btn-primary btn-lg btn-block" type="submit" name="submit">Update
				</button>
			</div>
